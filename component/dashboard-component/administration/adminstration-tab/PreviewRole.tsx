    ...
    <div className="grid grid-cols-1 gap-[0.5rem] p-[3%] bg-[#F9FFFF]">
      ...
      <div className="flex flex-col gap-[0.3rem]">
        ...
        <span className="flex items-center justify-between w-full">
          <p className="text-[#515B6F] text-[16px] font-[400]">Create User</p>
        ...
        <span className="flex items-center justify-between w-full">
          <p className="text-[#515B6F] text-[16px] font-[400]">Modify User</p>
        ...
        <span className="flex items-center justify-between w-full">
          <p className="text-[#515B6F] text-[16px] font-[400]">Create Role</p>
        ...
        <span className="flex items-center justify-between w-full">
          <p className="text-[#515B6F] text-[16px] font-[400]">Modify Role</p>
